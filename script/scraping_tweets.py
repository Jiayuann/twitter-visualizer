...
class TwitterSearchImpl(TwitterSearch):
    ...
    def save_tweets(self, tweets):
        ...
        :return:
        """
        f = open("/Users/jiayuan/Documents/data/project_263/tweets_data/tweets_adv1.json", "w+") 
        for tweet in tweets:
            ...
            if self.counter >= self.max_tweets:
                f.write(json.dumps(self.tweets_list))
                return False
...
if __name__ == '__main__':
	...
	#def __init__(self, rate_delay, error_delay, max_tweets):
    twit = TwitterSearchImpl(rate_delay_seconds, error_delay_seconds, 500)
