...
result_file = "/Users/jiayuan/Documents/data/project_263/tweets_bystate/single_file.csv"
...
class TwitterSearch:
    ...
    def search(self, query):
        ...
        while response is not None and continue_search and response['items_html'] is not None and counter_num <=1000:
